 ...
 *
 * Theme colours are controlled by CSS classes (.logo-icon-bg, .logo-accent-fill, etc.)
 * so the logo responds to [data-theme="light"] without any JS.
 */
...
export function AixLogo({ variant = "lockup" }: Props) {
  if (variant === "lockup") {
    return (
      ...
      >
        {/* ── Icon container ── */}
        <rect x="0" y="4" width="28" height="28" rx="4" className="logo-icon-bg" stroke="rgba(240,138,88,0.22)" strokeWidth="1" />

        {/* ── Three-circle signal mark ── */}
        <circle cx="8"  cy="18" r="3"   fill="none"                  stroke="rgba(240,138,88,0.5)" strokeWidth="1" />
        <circle cx="14" cy="18" r="4"   fill="rgba(240,138,88,0.1)"  stroke="#f08a58" strokeWidth="1.2" className="logo-accent-ring" />
        <circle cx="14" cy="18" r="1.5" className="logo-accent-fill" />
        <circle cx="20" cy="18" r="3"   fill="none"                  stroke="rgba(240,138,88,0.5)" strokeWidth="1" />
  ...
  return (
    ...
    >
      {/* ── Icon container ── */}
      <rect x="0" y="6" width="36" height="36" rx="5" className="logo-icon-bg" stroke="rgba(240,138,88,0.22)" strokeWidth="1" />

      {/* ── Three-circle signal mark ── */}
      <circle cx="10" cy="24" r="4"   fill="none"                  stroke="rgba(240,138,88,0.5)" strokeWidth="1.2" />
      <circle cx="18" cy="24" r="5.5" fill="rgba(240,138,88,0.1)"  stroke="#f08a58" strokeWidth="1.5" className="logo-accent-ring" />
      <circle cx="18" cy="24" r="2"   className="logo-accent-fill" />
      <circle cx="26" cy="24" r="4"   fill="none"                  stroke="rgba(240,138,88,0.5)" strokeWidth="1.2" />
